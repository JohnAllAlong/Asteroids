        ...
        if (this.b.length != 0) {
          for (let j = 0; j < this.b.length; ++j) {
            ...
            if(this.b[j].owner == "Player"){ 
              if(this.bLocation.x + this.bRad > this.sLocation.x - this.sRad &&
                this.bLocation.x - this.bRad < this.sLocation.x + this.sRad &&
            ...
            if(this.b[j].owner == "Enemy"){ 
              if(this.bLocation.x + this.bRad > this.pLocation.x - this.pRad &&
                this.bLocation.x - this.bRad < this.pLocation.x + this.pRad &&
